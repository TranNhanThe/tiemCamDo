...
function EnhancedTableToolbar({ numSelected, selected, setSelected, setRows }) {
  const handleDelete = async () => {
    try {
      ...
      if (response.status === 200) {
        ...
        console.error('Failed to delete bikes');
      }
    } catch (error) {
  ...
  const handleUpdateRows = (updatedBikes) => {
    setRows(updatedBikes);
  };
  ...
  return (
    ...
    >
      ...
      <Tooltip title="Add Bike">
        <IconButton>
          <AddBike onSubmit={handleUpdateRows} />
        </IconButton>
      </Tooltip>
    </Toolbar>
  );
...
export default function EnhancedBike() {
      ...
      <form onSubmit={handleSearch} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <FormControl fullWidth style={{ width: '30%',marginTop: '5px' }}>
          ...
          >
            ...
            <MenuItem value={'1'}>Kho số 1</MenuItem>
            <MenuItem value={'2'}>Kho số 2</MenuItem>
            <MenuItem value={'3'}>Kho số 3</MenuItem>
          </Select>
        </FormControl>
                ...
                {visibleRows.map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.kho}</TableCell>
